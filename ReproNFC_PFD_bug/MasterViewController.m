...
- (void)insertNewObject:(id)sender
{
    ...
    EventParent *parent = [NSEntityDescription insertNewObjectForEntityForName:@"EventParent" inManagedObjectContext:context];
      ...
      newIndexPath:(NSIndexPath *)newIndexPath
{
    ...
    switch(type) {
        ...
        case NSFetchedResultsChangeDelete:
            NSLog(@"Delete detected on row: %d", indexPath.row);
